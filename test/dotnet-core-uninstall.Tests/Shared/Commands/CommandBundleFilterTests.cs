...
namespace Microsoft.DotNet.Tools.Uninstall.Tests.Shared.Commands
{
    public class CommandBundleFilterTests
    {
        ...
        [MacOsOnlyTheory]
        [InlineData("remove --all-below 5.0.0 --sdk --preserve-mac-vs-sdks", new string[] { "1.0.0", "1.0.1", "1.1.0", "2.1.0", "2.1.500", "2.1.600", "2.2.100", "2.2.200" }, new string[] { })]
        [InlineData("remove --all-below 5.0.0 --sdk --force --preserve-mac-vs-sdks", new string[] { "1.0.0", "1.0.1", "1.1.0", "2.1.0", "2.1.500", "2.1.600", "2.2.100", "2.2.200" }, new string[] { })]
        [InlineData("remove --all-below 5.0.0 --runtime --preserve-mac-vs-sdks", new string[] { }, new string[] { "1.0.0", "2.1.0", "2.1.500", "2.2.100" })]
        [InlineData("remove --all-below 5.0.0 --runtime --force --preserve-mac-vs-sdks", new string[] { }, new string[] { "1.0.0", "1.0.1", "1.1.0", "2.1.0", "2.1.500", "2.1.600", "2.2.100", "2.2.200" })]
        [InlineData("remove --sdk 1.0.0 1.0.1 1.1.0 2.1.0 2.1.500 2.1.600 2.2.100 2.2.200 --preserve-mac-vs-sdks", new string[] { "1.0.0", "1.0.1", "1.1.0", "2.1.0", "2.1.500", "2.1.600", "2.2.100", "2.2.200" }, new string[] { })]
        [InlineData("remove --runtime 1.0.0 1.0.1 1.1.0 2.1.0 2.1.500 2.1.600 2.2.100 2.2.200 --preserve-mac-vs-sdks", new string[] { }, new string[] { "1.0.0", "1.0.1", "1.1.0", "2.1.0", "2.1.500", "2.1.600", "2.2.100", "2.2.200" })]
